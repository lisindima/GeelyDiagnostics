...
- **Сенсоры** — динамический список поддерживаемых `ISensor`, live-значения с
...
полученный от API, и lowercase-название поля monospace-шрифтом. Неизвестные коды
не угадываются и остаются в исходном числовом виде.

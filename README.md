...
- **Сенсоры** — единый каталог значений из ECARX AdaptAPI и системного VHAL с
  ...
  поиск, фильтры расшифровки/RAW/изменений/ошибок и избранное;
...
пользовательский файл и ничего не изменяет в автомобиле.
...
- `DiagnosticsViewModel.kt` — состояние диагностической сессии, подписки,
  избранное и автоматическое переподключение;

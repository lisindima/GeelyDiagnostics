...
Design или Split. В файле есть пять preview для ГУ `1440×1920`, по одному на
каждую вкладку.
...
```text
GeelyDiagnostics-v0.4.1-debug.apk
```

SHA-256: `5062AA814E91052299D78745A2E4453929D6F02E0BCE325AAFA9345A34C0A511`.

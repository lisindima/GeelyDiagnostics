...
Карточка сенсора сначала показывает источник и режим обновления, затем крупное
текущее значение, точный raw и lowercase-название поля monospace-шрифтом. Полные
технические детали вынесены из списка в полноэкранный режим. Бейдж VHAL-карточки

...
- **Автомобиль** — единый каталог статических заводских сведений ECARX и
  стандартных `INFO_*`-свойств VHAL;
- **Возможности** — единый каталог возможностей ECARX и доступных read-only
  свойств управления VHAL: их состояние, текущие значения, исходные raw, зоны

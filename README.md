...
- **Сенсоры** — единый каталог значений из ECARX AdaptAPI и системного VHAL с
  ...
  расшифровкой известных enum-кодов и обязательным отображением raw. Доступны
  поиск, фильтры расшифровки/RAW/изменений/ошибок и избранное. После применения
...
Полный снимок можно повторить кнопкой **«Обновить»** или жестом pull-to-refresh на любой вкладке.
...
Карточки во вкладках **«Сенсоры»**, **«Автомобиль»** и **«Функции»** используют
единый компонент: сначала показывают источник и тип данных, затем крупное текущее
значение на системной tonal-плашке, приглушённый точный raw и lowercase-название
поля monospace-шрифтом. Полные технические детали доступны в полноэкранном режиме. Бейдж VHAL-карточки
...
На вкладке **«Сенсоры»** можно явно выбрать один из доступных профилей:
